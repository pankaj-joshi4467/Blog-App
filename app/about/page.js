          ...
          <div className="space-y-12">
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <img src="/cur.png" alt="Pankaj as a beginner" className="w-full rounded-lg shadow-lg" />
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/3">
                <img src="/chal.png" alt=" working on a big project" className="w-full rounded-lg shadow-lg" />
              </div>
              <div className="md:w-2/3 md:pl-8 mt-8 md:mt-0">
...
For me, challenges fuel creativity and innovation 🔥. They remind me that growth begins when we step outside our comfort zone. </p>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              <div className="md:w-1/3">
                <img src="/back.png" alt="Harry mentoring others" className="w-full rounded-lg shadow-lg" />
              </div>
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Giving Back</h3>
                <p className="mt-4 text-gray-600 dark:text-gray-50">
                 I believe knowledge grows when it is shared. Through this blog, I try to give back to the developer community by sharing my learnings, experiences, and practical tips.
...
Helping others motivates me to keep learning and improving. It feels great to know that even a small blog post or a simple tip can make someone&apos;s coding journey smoother. 💻✨</p>
       ...
       <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#323135] to-[#380B60] text-white/70">
                ...
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">PankajBlog</a>. All rights reservered.</p>
